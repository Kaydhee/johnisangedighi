					...
					<div className='flex flex-col gap-4'>
						<Article>
							...
							<p className='text-sm text-secondary'>
								...
								demands of thistype of valuation, the mortgagee ought not to
								rely on the open market value of the property as the basis for
								disbursement, but should instead rely on forced sale value of
								the property. We are grounded in the art and science of this
								type of valuation as we advise either party or both as to the
								most judicious figure to adopt having regard to the possibility
								of FORECLOSURE.
							</p>
						</Article>
						...
						<Article>
							...
							<p className='text-sm text-secondary'>
								...
								manage.One of the primary requirements is an INFORMED OPINION on
								the worth of the component assets of the company. This is where
								a qualified valuer comes in. We are versed with the mechanics of
								such an exercise having undertaken some successfully in the
								past.
							</p>
						</Article>
					</div>
					...
					<div className='flex flex-col items-center justify-between gap-4'>
						<Article>
							...
							<p className='text-sm text-secondary'>
								...
								machinery, fixtures and fittings, goodwill and in some instances
								trademark and patent. Trademark and patent are not fixed or
								tangible assets neither are they common valuation items.
								Goodwill also falls in that category. In agoing concern
								business, however, these three (3) items are most critical and
								should be taken into account in a valuation exercise. Our firm
								is capable of undertaking such exercise for the benefit of the
								client.
							</p>
						</Article>
						...
						<div className='flex items-center justify-between gap-4 mb-4'>
							<Article>
								...
								<p className='text-xs sm:text-sm text-secondary'>
									...
									undertaing such exercise. We are trained and also experienced
									to undertake such excercise.
								</p>
							</Article>
							<Article>
								<h4 className='text-secondary font-bold'>
								...
								<p className='text-xs sm:text-sm text-secondary'>
									...
									explicitly mentioned. As a result, the estate surveyor and
									valuer is expected to exercise discretion.
								</p>
							</Article>
						</div>
					</div>
				...
				<section>
					<Article>
						...
						<p className='text-secondary'>
							...
							a prospective vendor or purchaser as to the best value of a
							subject property.
						</p>
					</Article>
					...
					<div className='flex items-center justify-between flex-wrap sm:flex-nowrap gap-4 mt-4'>
						<Article>
							...
							<p className='text-secondary'>
								...
								This Law provides for the valuation of land, buildings and
								economic trees.
							</p>
						</Article>
						<Article>
							...
							<p className='text-secondary'>
								...
								of operational efficiency of the items.
							</p>
						</Article>
						<Article>
							<h4 className='text-secondary font-bold'>
							...
							<p className='text-secondary'>
								...
								maximize efficiency or meet some other businesd goals. The flip
								side is where one of the companies is acquiring or taking over
								the other. Any of the above postulates the continuance of the
								business Consequently, the alternative use value basis might be
								adopted in such an exercise.
							</p>
						</Article>
						<Article>
							...
							<p className='text-secondary'>
								...
								full replacement or reinstatement cost of the asset.
							</p>
						</Article>
					</div>
				</section>

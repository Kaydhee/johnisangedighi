...
export default function PropertyModal() {
	...
	return (
		<section className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50'>
			<div className='bg-primaryVariant p-6 rounded shadow-lg max-w-lg w-full'>
				...
				<div className='flex gap-4'>
					...
					<button
						className='mt-4 bg-transparent border border-secondary text-secondary px-4 py-2 rounded'
						onClick={() => dispatch(toggleModal())}>
						proceed{' '}
					</button>
				</div>
